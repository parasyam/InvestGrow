...
function sip(){
    ...
    let result=Math.round(capital*((Math.pow((1+i),n)-1)/i)*(i+1));

    let profits=result-invest
    let w=Math.round(result*0.6);
    let h=Math.round(result-w);

    document.getElementById("result").innerHTML=
    "Invested Value: "+invest.toLocaleString()+"<br>"+"<br>"+
    "Returns: "+profits.toLocaleString()+"<br>"+"<br>"+
    "Total Amount: "+result.toLocaleString()+"<br>"+"<br>"+
    "Max.withdrawable Amount:"+w.toLocaleString()+"<br>"+"<br>"+
    "Remaining "+h.toLocaleString()+" can be use to give monthly pension";
